...
const TransactionDetail = ({ tx, onEdit, onDelete, onClose }) => (
  <div>
    ...
    <div className="divide-y" style={{ borderColor: C.border }}>
      ...
      <DetailRow label="Catatan">{tx.notes || "—"}</DetailRow>
    ...
    <div className="rtd-root flex min-h-screen" style={{ background: C.bg }}>
      ...
      {modal?.type === "detail" && (
        <Modal title="Detail Transaksi" subtitle={modal.tx.transaction_code} onClose={() => setModal(null)}>
          <TransactionDetail tx={modal.tx} onEdit={actions.edit} onDelete={actions.del} onClose={() => setModal(null)} />
        </Modal>
      )}
